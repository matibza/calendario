...
var presentismo = 0;
	...
	var contador = 0;
					for (var i = 1; i < 43;) {
						...
						b = "g" + i;
						bc = "b" + i;
						var ferido = window.getComputedStyle(document.getElementById(bc)).backgroundColor;
						...
						if ((ferido == "rgb(255, 0, 0)") && (bb2 !== "rgb(128, 128, 128)") ) {
							al150++;
						}
...
function sabados() {
	...
	var sexto = window.getComputedStyle(document.getElementById("g43")).backgroundColor;
		...
		if ((primer == "rgb(255, 165, 0)") || (primer == "rgb(0, 0, 255)")) {
				al50++;
		}
		if ((segundo == "rgb(255, 165, 0)") || (segundo == "rgb(0, 0, 255)")) {
				al50++;
		}
		if ((tercer == "rgb(255, 165, 0)") || (tercer == "rgb(0, 0, 255)")) {
				al50++;
		}
		if ((cuarto == "rgb(255, 165, 0)") || (cuarto == "rgb(0, 0, 255)")) {
				al50++;
		}
		if ((quinto == "rgb(255, 165, 0)") || (quinto == "rgb(0, 0, 255)")) {
				al50++;
		}
		if ((sexto == "rgb(255, 165, 0)") || (sexto == "rgb(0, 0, 255)")) {
				al50++;
		}
...
function sabado_man() {
	...
	var sexto2 = window.getComputedStyle(document.getElementById("b43")).backgroundColor;
		if ((primer == "rgb(0, 128, 0)")) {
				al50++;
		}
		if ((segundo == "rgb(0, 128, 0)")) {
				al50++;
		}
		if ((tercer == "rgb(0, 128, 0)")) {
				al50++;
		}
		if ((cuarto == "rgb(0, 128, 0)")) {
				al50++;
		}
		if ((quinto == "rgb(0, 128, 0)")) {
				al50++;
		}
		if ((sexto == "rgb(0, 128, 0)")) {
				al50++;
		}
