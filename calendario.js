...
var mes = 1;
var ac = "";
var cambiar_año = 2026;
var inicio = 5; //NOTA: PARA CAMBIAR DE AÑO SOLO MODIFICAR ESTA VARIABLE Y EL NUMERO DEL AÑO EN EL MISMO INDEX.html
...
function año() {
	document.getElementById('tit').innerHTML = cambiar_año;
}
function blanquear() {
		for (var i = 2; i < 506; i++) {
			ac= "a" + i
	...
	if (año == añocalend) {
		if (mes == 0) {
			for (var i = 2; i <= 43;) {
				...
				if (rr2 == dia) {
				document.getElementById(rr).style.backgroundColor = '#8d0588';
